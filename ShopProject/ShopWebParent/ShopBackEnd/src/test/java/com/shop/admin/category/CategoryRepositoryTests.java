...
public class CategoryRepositoryTests {
	...
	public void testCreateSubCategory() {
		...
		Category sub = new Category("Iphones", parent);
		Category saveCat = repo.save(sub);
	...
	public void testGetCategory() {
		...
		Set<Category> chidren = category.getChildren();
		for (Category subCategory : chidren) {
			System.out.println(subCategory.getName());
		}
		assertThat(chidren.size()).isGreaterThan(0);
